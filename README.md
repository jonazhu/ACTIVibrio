...
## Directory structure
Overview of original directory structure can be found in tree.txt file.

Each processed video was found in results_images subdirectory.
...
All processed embeddings are stored in vc_mutant_data.csv.
Only the csv is necessary to run each algorithm. The original videos were preprocessed before uploading to this repository.
